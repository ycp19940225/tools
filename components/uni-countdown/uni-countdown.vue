<template>
	<view class="uni-countdown">
		<text v-if="showTitle" class="uni-countdown__splitor">{{ title }}</text>
		...
		<text v-if="showSeconds" :style="{ borderColor: borderColor, color: color, backgroundColor: backgroundColor}" class="uni-countdown__number">{{ s }}</text>
		<text v-if="!showColon && showSeconds" :style="{ color: splitorColor }" class="uni-countdown__splitor">秒</text>
	</view>
</template>
<script>
	export default {
