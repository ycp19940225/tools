		...
		<scroll-view class="scroll" scroll-y>
			<view class="scroll-content">
				<view class="introduce-section">
					...
					<u-parse :content="detailData.content" @preview="preview" @navigate="navigate" />
	...
	export default {
		...
		methods: {
			...
			async loadNewsList(){
				...
				this.$http.post('/api/content/getArticleRelate', data).then(res => {
					console.log(res)
					if (res.data.code != 1) {
						uni.showToast({
							title: res.data.info,
